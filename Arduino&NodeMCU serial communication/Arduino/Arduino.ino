...
void printTemperature(int averageHeartRate, float averageSpO2, float averageSystolicBP, float averageDiastolicBP) {
  ...
  Serial3.println(averageHeartRate);
  Serial3.print(" averageSpO2:");
  Serial3.println(averageSpO2);
  Serial3.print("averageSystolicBP:");
  Serial3.println(averageSystolicBP);
  Serial3.print(" averageDiastolicBP:");
  Serial3.println(averageDiastolicBP);

  Serial3.print("Body Temp:");
  Serial3.println(tempC);
  Serial3.print(" Room Temperature:");
